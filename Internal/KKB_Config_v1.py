...
cnfg_load_btn = Act('loadConfiguration()', 'Load Scan Parameters')
cnfg_load_btn.colspan = 25

cnfg_save_btn = Act('saveConfiguration()', 'Save Scan Parameters')
cnfg_save_btn.colspan = 25
...
g0.add(btnPlotSteps, cnfg_save_btn, cnfg_load_btn, btnTimeEstimation, txtTimeEstimation)
