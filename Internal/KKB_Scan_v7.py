...
steps_templates_list.append([
    'Si311: Logarithmic Scan (Empty Cell)',
    'ba',
    'logscale',
    [25, 2e-5, 1000, 1200],
    [16, 23.0, 1000, 1200]])
...
print("DEBUG: ss1r0 = " + str(ss1r0))
print("DEBUG: ss1l0 = " + str(ss1l0))
...
def startScan(configModel):
    ...
    if hasattr(configModel, 'prop_id'):
        sics.execute('hset experiment/experiment_identifier ' + configModel.prop_id)
