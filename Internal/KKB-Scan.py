...
steps_templates_dict['Background'] = [
    'time', 'logscale',
    [20, 6.0e-5,  1200, 1200]]
...
steps_templates_dict[' Si111: Logarithmic Scan (fine features)'] = [
    'ba', 'logscale',
    [33, 6.0e-5,  1000, 1200],
    [73, 8.0e-5,  1000, 1200]]

steps_templates_dict[' Si111: Logarithmic Scan (few features)'] = [
    'ba', 'logscale',
    [33, 6.0e-5,  1000, 1200],
    [33, 2.0e-4,  1000, 1200]]

steps_templates_dict[' Si111: Logarithmic Overview Scan'] = [
    'time', 'logscale',
    [17, 1.20e-4,  1, 1200],
    [30, 2.0e-4,  20, 1200]]
...
steps_templates_dict['  Si311: Logarithmic Scan (fine features)'] = [
    'ba', 'logscale',
    [31, 2e-5,    1000, 1200],
    [60, 2.5e-5,  1000, 1200]]

steps_templates_dict['  Si311: Logarithmic Scan (few features, broadened peak)'] = [
    'ba', 'logscale',
    [80, 2e-5,  1000, 1200],
    [29, 1e-4,  1000, 1200]]

steps_templates_dict['  Si311: Logarithmic Overview Scan'] = [
    'time', 'logscale',
    [17, 2.0e-5,  1, 1200],
    [30, 3.7e-5,  20, 1200]]
...
g0.numColumns = 100 #9
g0.add(scan_variable,  scan_mode, scan_reference, logscale_position, scan_min_time, scan_sam_position, empty_label, steps_label, steps_templates)
...
g0.add(btnPlotSteps, cnfg_save_btn)
...
g0 = Group('Plotting')
g0.numColumns = 16
g0.add(tubes_label, combine_tube0, combine_tube1, combine_tube2, combine_tube3, combine_tube4, combine_tube6, combine_mode, trans_tube_label, check_tube9, check_tube10, steps_space, scan_variable_plot, scan_variable_sorting, btnPlot)
...
def btnPlotSteps_clicked():
    ...
    try:
        for mask in Plot2.masks:
            Plot2.remove_mask(mask)
    except:
        pass
    ...
    q = [(f*sin((x-scan_reference.value)*3.1415/360)) for x in angles]
     
    if Plot2.get_dataset() is None:
