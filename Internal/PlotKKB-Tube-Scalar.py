...
def proc_fn(path):
    ...
    # by nxi, add support for data with just one scan point
    if len(ds) == 1:
        proc_scalar(ds, basename)
        return
    ...
    '''
    Plot1.set_mouse_follower_precision(5, 2, 2)
    Plot2.set_mouse_follower_precision(5, 2, 2)
    Plot3.set_mouse_follower_precision(5, 2, 2)
